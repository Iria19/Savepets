...
<?php }else{ ?><script src="//code.tidio.co/qypk38tfjsh2tm78hf5uwcka5sqbtm8o.js" async></script><!--Ingles-->
<?php    } ?>
<body>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <?php if($this->Identity->isLoggedIn()){
                ...
                <?php } ?>
                    ...
                    <li class="nav-item">
                      <?php 
                      if (I18n::getLocale() !== 'en_US'){ //en ingles
                      ?>              
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="stats-item text-center w-100 h-100">
              <span data-purecounter-start="0" data-purecounter-end="285000" data-purecounter-duration="2" class="purecounter"></span>
